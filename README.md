...
In this example, `+` is used to communicate there is another sequence to be matched. We also used `{2,6}`  to specify the input should be a minimum of 2 characrtors to a maximum of 6 characters.
...
Github repository: https://github.com/DillanThomas88